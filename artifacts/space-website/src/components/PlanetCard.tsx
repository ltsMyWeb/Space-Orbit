      ...
      <Card className="glass-card relative border border-white/10 overflow-hidden h-full rounded-2xl z-10 transition-colors group-hover:border-white/20">
        <CardContent className="p-8 flex flex-col h-full items-center text-center gap-6">
          <div className="relative w-32 h-32 flex items-center justify-center">
            ...
            <div className="absolute inset-[-20%] rounded-full border border-dashed opacity-0 group-hover:opacity-100 group-hover:animate-spin-slow transition-opacity duration-700 pointer-events-none" 
                 style={{ borderColor: color }} />
                 
            <div 
              className="w-24 h-24 rounded-full shadow-lg relative z-10 transition-transform duration-700 group-hover:scale-110"
              style={{ 
